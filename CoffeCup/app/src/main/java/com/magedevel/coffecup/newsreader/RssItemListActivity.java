...
/**
 * An activity representing a list of RssItems. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link RssItemDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link RssItemListFragment} and the item details
 * (if present) is a {@link RssItemDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link RssItemListFragment.Callbacks} interface
...
public class RssItemListActivity extends Activity
    ...
    /**
     * Callback method from {@link RssItemListFragment.Callbacks}
    ...
    public void onItemSelected(Integer id) {
        if (mTwoPane) {
            ...
            //arguments.putString(RssItemDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(RssItemDetailActivity.ARG_ITEM_ID, id);
