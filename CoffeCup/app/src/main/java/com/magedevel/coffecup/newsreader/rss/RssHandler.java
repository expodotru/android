...
public class RssHandler extends DefaultHandler {
    ...
    private List<News> articleList = new ArrayList<News>();
    ...
    private static final int ARTICLES_LIMIT = 30;

    //Current characters being accumulated
    StringBuffer chars = new StringBuffer();

    public RssHandler(RssSource source){
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (localName.equalsIgnoreCase("title")){
            ...
            currentArticle.setSummary(chars.toString());
        ...
        if (localName.equalsIgnoreCase("description")) {
            ...
            News newAdd=new News(currentArticle.getTitle(),
                    "",
